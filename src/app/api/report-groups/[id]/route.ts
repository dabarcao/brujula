...
// GET /api/report-groups/[id] -> reportGroupsManager.getGroup.

import "server-only";
import { getGroup } from "@/server/managers/reportGroupsManager";
...
export async function GET(
  ...
  try {
    ...
    console.error("[report-groups] GET /api/report-groups/[id] unexpected non-Error throw:", error);
