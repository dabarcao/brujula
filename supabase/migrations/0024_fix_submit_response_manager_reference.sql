-- Brújula — arregla un olvido de la migración 0020 (eliminación del rol
-- Jefe / is_manager): submit_feedback_response todavía seleccionaba
-- m.is_manager, una columna que ya no existe. Rompía el guardado de
-- cualquier respuesta (autoevaluación y feedback de compañeros) con
-- "column m.is_manager does not exist".
